...
1. [Introducción](#t1)\
   ...
   1.2 [Filtros FIR](#t7)\
     1.2.1 [Método de las ventanas](#t7)\
   1.3 [Filtros IIR](#t7)
     1.3.1 [Métodos de Diseño de Filtros IIR](#t7)\
...
#### 1.2.1 Método de las ventanas:  <a name = "t1"></a>
...
<a name = "t1"></a> <p align="justify"> Los diferentes tipos de filtros IIR se utilizan según las necesidades de suavidad, selectividad y tolerancia a ondulaciones en las bandas de paso o de stop, dependiendo de la aplicación en la que se empleen [8].
...
|------------------|--------------------------|
| ![Butterworth](<img src="Anexo_Biceps/Captura de pantalla 2024-10-06 203600.png") | ![Chevyshev Tipo I](<img src="Anexo_Biceps/Captura de pantalla 2024-10-06 203543.png") |
| ![Chevyshev Tipo II](<img src="Anexo_Biceps/Captura de pantalla 2024-10-06 203617.png")  | ![Elíptico](<img src="Anexo_Biceps/Captura de pantalla 2024-10-06 203632.png") |

| **Filtro**               | **Imagen**                                                                 |
|--------------------------|---------------------------------------------------------------------------|
| [Butterworth]             | ![Butterworth](Anexo_Biceps/Captura de pantalla 2024-10-06 203600.png)     |
| [Chebyshev Tipo I]        | ![Chebyshev Tipo I](Anexo_Biceps/Captura de pantalla 2024-10-06 203543.png)|
| [Chebyshev Tipo II]       | ![Chebyshev Tipo II](Anexo_Biceps/Captura de pantalla 2024-10-06 203617.png)|
| [Elíptico]                | ![Elíptico](Anexo_Biceps/Captura de pantalla 2024-10-06 203632.png)        |
