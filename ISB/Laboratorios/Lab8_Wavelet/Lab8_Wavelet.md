...
<p align="justify"> Durante el proceso de eliminación de ruido en señales ECG, EMG y EEG, la DWT demostró ser una herramienta efectiva. Las familias de wavelets seleccionadas, en especial la Daubechies (db4) para las señales ECG y las wavelets Coiflets y Symlets para las EEG, mostraron un buen balance entre la eliminación de ruido y la preservación de características clave de las señales. Esto refuerza la aplicabilidad de la DWT en el procesamiento de señales biomédicas, como se documenta en estudios previos. </p>

<p align="justify"> En comparación con técnicas tradicionales como los filtros pasa bajos o pasa altos, la transformada wavelet ofrece una ventaja significativa al permitir un análisis multiresolución. Esto fue particularmente evidente en la señal ECG, donde la umbralización suave y la eliminación del ruido de desvío de línea base permitieron obtener señales más limpias sin afectar las características morfológicas importantes para el análisis diagnóstico. </p>
